<%@ Page Title="Kullanıcı Detay ve Sipariş" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Kullanici.aspx.cs" Inherits="SuSiparis.Siparis.UserManager.Kullanici" %>
    ...
    <div style="position:relative;margin:20px;">
        <div style="left:100px;top:150px;background-color:antiquewhite;padding:50px;box-shadow: 0 14px 18px 0 rgba(61, 11, 127, 0.2), 0 16px 20px 0 rgba(61, 11, 127, 0.2);border-radius:5px;">
                <asp:FormView ID="FormView1" runat="server" ItemType="SuSiparis.Models.IdentityModels+ApplicationUser" DataKeyNames="UserName" SelectMethod="FormView1_GetItem">
                    <ItemTemplate>
                        <img src="../UserManager/photo/<%#:Item.UserImg%>" style="width:100px;box-shadow: 0 4px 8px 0 rgba(255, 99, 71, 0.5), 0 6px 20px 0 rgba(255, 99, 71, 0.5);"/>                                  
                       ...
                       <p class="kullaniciInfo"><a href="#EditPanel" id="btnEditProfile">Profil Düzenle</a></p>
                    </ItemTemplate>
            </asp:FormView>
        </div>
        
    </div> 
    <div style="box-shadow: 0 4px 8px 0 rgba(255, 99, 71, 0.5), 0 6px 20px 0 rgba(255, 99, 71, 0.5);margin:10px;padding:10px;background-color:aliceblue;visibility:hidden" id="EditPanel">
       <h4 style="text-align:center;">Profil Detayları</h4>
        <div style="padding:10px;margin-left:100px;">
            <asp:FormView ID="FormView2" runat="server" ItemType="SuSiparis.Models.IdentityModels+ApplicationUser" DataKeyNames="UserName" SelectMethod="FormView1_GetItem">
                <ItemTemplate>
                    <img src="../UserManager/photo/<%#:Item.UserImg%>" style="margin:20px;width:100px;box-shadow: 0 4px 8px 0 rgba(255, 99, 71, 0.5), 0 6px 20px 0 rgba(255, 99, 71, 0.5);" />
               </ItemTemplate>
            </asp:FormView>
